...
// ─── SHARED LABEL STYLE (same as MenuPage) ────────────────────────────────────
const labelStyle = {
...
// ═════════════════════════════════════════════════════════════════════════════
export default function CategoryForm({ initialData = null, onClose, onSuccess }) {
    ...
    const validate = () => {
        ...
        if (form.usefulLife !== "" && (isNaN(Number(form.usefulLife)) || Number(form.usefulLife) < 0))
    ...
    const handleSave = async () => {
        ...
        const payload = {
            ...
            depreciationRate:
                form.depreciationRate !== "" ? parseFloat(form.depreciationRate) : 20,
            usefulLife: form.usefulLife !== "" ? parseInt(form.usefulLife) : undefined,
        ...
        try {
            const action = isEdit
                ? dispatch(updateCategory({ id: initialData.id, ...payload }))
                        ...
                        >
                            <div>
                                ...
                                <p style={{ color: "var(--text-muted)", fontSize: 12, margin: 0 }}>
                                    Inactive categories won't appear for non-admins
                                </p>
                            </div>
                            <button
                                type="button"
